...
CREATE TABLE `EVENT`(`ID` 
	...
	ALTER TABLE devis DROP FOREIGN KEY fk_devis_product;
	`category` (
	    `id` int NOT NULL AUTO_INCREMENT PRIMARY KEY,
	...
	CREATE TABLE
	    `devisproduct` (
	        ...
	        CONSTRAINT fk_devisproduct_product FOREIGN KEY (product_id) REFERENCES product(id),
	        `devis_id` INT NOT NULL,
	        CONSTRAINT fk_devisproduct_devis FOREIGN KEY (devis_id) REFERENCES devis(id)
	    );
	...
	=======
		        ...
		        'Du 1/04 au 31/10 : 14 jours <br> Du 1/11 au 31/03 : 28 jours',
	          1
	>>>>>>> 520d045d4f7169b045cd2f55720ff0588d546950
		    ), (
		        'Spéciale de Claires',
